        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-6">
          ...
          <div className="flex flex-col lg:flex-row shadow-xl rounded-lg overflow-hidden bg-white">
            ...
            <div className="w-full lg:w-2/3 p-8 sm:p-12 lg:p-16">
              ...
              <h3 className="text-2xl md:text-3xl font-extrabold text-black font-heading mb-4">
                Send us a message
              </h3>

              <p className="text-black/80 mb-6">
                Tell us about your project, product question, or bulk-order needs — we’ll respond quickly.
              </p>
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <div>
                    <label
                      htmlFor="name"
                      className="block mb-2 text-sm font-medium text-black/80"
                    >
                      Your Name
                    </label>
                    ...
                    <input
                      type="text"
                      id="name"
                      className="bg-white border border-brand-100 text-black/90 text-sm rounded-lg block w-full p-3"
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    id="message"
                    rows="6"
                    className="block p-3 w-full text-sm text-black/80 bg-white rounded-lg border border-brand-100"
            ...
            <div className="w-full lg:w-1/3 bg-gradient-to-br from-brand-700 to-brand-500 p-8 sm:p-12 flex flex-col justify-between text-white">
              ...
              <div>
                ...
                <p className="mb-8 text-amber-100/95">
                  Visit our store or contact us by phone/email for quick, friendly support and local delivery options.
                </p>
                ...
                <ul className="space-y-6">
                  ...
                  <li className="flex items-start">
                    ...
                    <svg
                      className="w-6 h-6 mr-3 flex-shrink-0 text-amber-100/90"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <li className="flex items-start">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M3 8l7.84 5.23a2 2 0 002.32 0L21 8"
                      />
                    </svg>
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:info@gayatritrade.com"
                        className="opacity-80 hover:underline text-amber-100/90"
                      >
